  ...
  generateUrl(type) {
    ...
    if (type == "click") {
      ...
      if (this.impressionURL) {
        ...
        console.debug(
          "impressionURL not defined. To use generateURL(impression) make sure to pass impressionURL in the constructor."
        )
        return null
      }
    } else {
      console.debug(
        "Invalid input value for generateURL(type). Please pass 'click' or 'impression'."
      )
      return null
    }
